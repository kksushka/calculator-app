      ...
      t.addEventListener("click", () =>
        ((t) => {
          const { action: e } = t.dataset,
            n = t.textContent;
          if (!e) {
            if ((k && ((w = ""), (k = !1)), "." === n && /\.\d*$/.test(w)))
              return;
            if (w.length >= 30) return;
            return (w += n), void _(x, w);
          }
          A[e]
            ? A[e]()
            : E[e] &&
      ...
      (() => {
        ...
        t.forEach((e) => {
          e.addEventListener("click", () => {
            const n = "light-theme" === e.id ? "light" : "dark";
